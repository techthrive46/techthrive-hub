...
export function ProjectsIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7Z" />
    </svg>
  );
}
...
export function MailIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8.5 12 14l9-5.5M5 19h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2Z" />
    </svg>
  );
}
...
export function YoutubeIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10 9.5v5l4.5-2.5L10 9.5ZM22 12c0 2.5-.3 4.2-.5 5-.2.9-1 1.6-1.9 1.8-1.7.4-8.6.4-8.6.4s-6.9 0-8.6-.4c-.9-.2-1.7-.9-1.9-1.8C1 16.2 1 14.5 1 12s.3-4.2.5-5c.2-.9 1-1.6 1.9-1.8C5.1 5.8 12 5.8 12 5.8s6.9 0 8.6.4c.9.2 1.7.9 1.9 1.8.2.8.5 2.5.5 5Z" />
    </svg>
  );
}
