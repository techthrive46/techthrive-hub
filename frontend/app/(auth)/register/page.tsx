...
export default function RegisterPage() {
  ...
  return (
    <Card className="tech-frame shadow-lg">
      <p className="tech-label">auth.register()</p>
      <CardTitle className="mt-1 text-lg">Initialize account</CardTitle>
      <CardDescription className="normal-case">Set up your workspace</CardDescription>
